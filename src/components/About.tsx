...
const skillsArray = [
  ...
  { icon: Globe, ...skills.backend },
  { icon: Cpu, ...skills.mobile },
  { icon: BookOpen, ...skills.database },
];
  ...
  return (
    ...
    >
      <div className="text-center mb-12 md:mb-16">
        ...
        >
          I'm an Electronics & Communication Engineering undergraduate with a passion for research, space technology, and applied electronics.
          Experienced in technical projects, hackathons, and research internships with exposure to real-world experimental systems.
        </p>
      </div>
